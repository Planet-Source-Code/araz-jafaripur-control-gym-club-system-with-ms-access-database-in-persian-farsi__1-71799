...
Begin VB.Form FrmRPay 
   BackColor       =   &H80000013&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "ÔåÑíå åÇí ÑÏÇÎÊí"
   ClientHeight    =   7845
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8370
   ...
   Begin VB.Label lblInstruct 
      ...
      Caption         =   "ÒÇÑÔ ÔåÑíå åÇí ÑÏÇÎÊ ÔÏå ˜ÇÑÈÑÇä ÈÇÔÇå"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   9.75
         Charset         =   178
   ...
   Begin VB.Image Image2 
      ...
      Height          =   855
      Left            =   0
      Picture         =   "FrmRPay.frx":3667
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8415
   End
End
Attribute VB_Name = "FrmRPay"
...
Dim StrFilter As String
StrFilter = "DateGive_M >= '" & Shamsi.Convert_Date(TxtFrom.Text, HijriShamsi_, Gregorian_) & _
    "' AND DateGive_M <= '" & Shamsi.Convert_Date(TxtTo.Text, HijriShamsi_, Gregorian_) & "'"
...
StrSQL = "SELECT User.ID,User.Name,User.Family,Pay.DateGive_S,Pay.TimeGive,Pay.DateGive_M" & _
    " FROM [User],Pay WHERE User.ID = Pay.UID ORDER BY Pay.DateGive_M DESC"
...
With dtaDel
    ...
    .Columns(3).DataField = "DateGive_S"
    .Columns(3).Caption = "ÊÇÑíÎ ÑÏÇÎÊ"
        
    .Columns(4).DataField = "TimeGive"
    .Columns(4).Caption = "ÓÇÚÊ ÏÑíÇÝÊ"
        
    .Columns(5).DataField = "DateGive_M"
    .Columns(5).Caption = "M"
