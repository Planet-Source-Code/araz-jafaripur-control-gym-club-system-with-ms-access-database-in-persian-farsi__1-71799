...
If Val(TxtPassword.Text) <> Val(TxtPassword2.Text) Then
    ...
    Exit Sub
End If
If MsgBox("¬Ì« „«Ì· »Â «›“Êœ‰ «Ì‰ „œÌ— Â” Ìœ ø", vbQuestion + vbYesNo, "„œÌ—") = vbNo Then
    Exit Sub
End If
...
With AdoAdmin
    ...
    .Recordset.Update
End With
MsgBox "„œÌ— »Â »—‰«„Â «÷«›Â ‘œ", vbInformation, "„œÌ—"
Exit Sub
ERR_Control:
