...
Begin VB.Form FrmRUser 
   BackColor       =   &H80000013&
   BorderStyle     =   1  'Fixed Single
   Caption         =   "˜ÑÈÑÇä ÈÇÔÇå"
   ClientHeight    =   7875
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   8400
   ...
   Begin VB.Image Image2 
      ...
      Height          =   855
      Left            =   0
      Picture         =   "FrmRUser.frx":3667
      Stretch         =   -1  'True
      Top             =   0
      Width           =   8415
   End
End
Attribute VB_Name = "FrmRUser"
...
Dim StrFilter As String
StrFilter = "DateReg_M >= '" & Shamsi.Convert_Date(TxtFrom.Text, HijriShamsi_, Gregorian_) & _
    "' AND DateReg_M <= '" & Shamsi.Convert_Date(TxtTo.Text, HijriShamsi_, Gregorian_) & "'"
...
StrSQL = "SELECT ID,Name,Family,ShomareSh,Job,BirthDay_S,DateReg_S,Address,Tell,DateReg_M FROM [User] ORDER BY ID DESC"
...
With dtaDel
    ...
    .Columns(3).DataField = "ShomareSh"
    .Columns(3).Caption = "ÔãÇÑå ÔäÇÓäÇãå"
        
    .Columns(4).DataField = "Job"
    .Columns(4).Caption = "ÔÛá"
        
    .Columns(5).DataField = "BirthDay_S"
    .Columns(5).Caption = "ÊÇÑíÎ ÊæáÏ"
    
    .Columns(6).DataField = "DateReg_S"
    .Columns(6).Caption = "ÊÇÑíÎ ÚÖæíÊ"
    
    .Columns(7).DataField = "Address"
    .Columns(7).Caption = "ÂÏÑÓ"
    
    .Columns(8).DataField = "Tell"
    .Columns(8).Caption = "ÊáÝä"
    
    .Columns(9).DataField = "DateReg_M"
    .Columns(9).Caption = "D"
